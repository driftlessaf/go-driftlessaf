...
// provider model ID, and explicit capability allow-set. Resolution intersects
// route, model-family, and protocol support. It does not construct provider
// clients or load credentials; those responsibilities belong to protocol
// adapters.
//
